...
class UCIParser {
  ...
  /**
   * Serialize sections back to UCI format
   * @param {Map} sections - Map of section data
   ...
   * @param {Map} sections - Parsed sections
   * @param {string} sectionType - Type to filter by
